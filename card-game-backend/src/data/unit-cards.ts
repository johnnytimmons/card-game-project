...
export const unitCards: UnitCard[] = [
  ...
  { id: 3, name: 'Bear', type: 'Creature', health: 40, damage: 25 },
  ...
  { id: 7, name: 'Obsidian', type: 'Unit', health: 35, damage: 25, ability: "Berserker" },
  { id: 8, name: 'Griffin', type: 'Creature', health: 30, damage: 30, ability: "Flight" },
  { id: 9, name: 'Claw Drill', type: 'Vehicle', health: 50, damage: 15, ability: "Tunnel" },
  { id: 10, name: 'Ripwing', type: 'Vehicle', health: 25, damage: 30, ability: "Swiftness" },
  { id: 11, name: 'Thunderwing', type: 'Vehicle', health: 40, damage: 10, ability: "Bombing Run" }
