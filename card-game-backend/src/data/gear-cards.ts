...
export const gearCards: GearCard[] = [
  { id: 100, name: 'Shield', type: 'Defense', ability: "+10 Def" },
  ...
  { id: 105, name: 'Stim Pack', type: 'Defense', damage: 10 , ability: "-5 Def" },
  { id: 106, name: 'Med Pen', type: 'Heal', ability: "+20 Health" }
];